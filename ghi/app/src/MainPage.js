function MainPage() {
  return (
    ...
    <div className="bg-blue-700 text-center rounded-lg px-6 py-8 ring-1 ring-slate-900/5 shadow-xl w-full">
...
<div className="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
    ...
    <div className="hidden duration-700 ease-in-out" data-carousel-item>
        ...
        <img src="https://www.hdcarwallpapers.com/walls/aston_martin_dbs_770_ultimate_2023_8k_3-HD.jpg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
    </div>

    <div className="hidden duration-700 ease-in-out" data-carousel-item>
        <img src="https://images.hdqwalls.com/wallpapers/ford-gt-2020-42.jpg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
    </div>

    <div className="hidden duration-700 ease-in-out" data-carousel-item>
        <img src="https://wallpapercave.com/wp/wp5636803.jpg" className="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2" alt="..."/>
    </div>
</div>

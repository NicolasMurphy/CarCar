        ...
        <div className="flex h-17">
          ...
          <div className="hidden md:block">
            <div className="ml-8 flex items-baseline my-3 space-x-2">
              ...
              <button id="dropdownDefaultButton1" data-dropdown-toggle="dropdown1" className="text-white bg-grey-700 hover:bg-cyan-850 focus:ring-4 focus:outline-none focus:ring-cyan-850 font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center dark:bg-cyan-950 dark:hover:bg-cyan-800 dark:focus:ring-cyan-950" type="button">Inventory <svg className="w-4 h-6 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 9l-7 7-7-7"></path></svg></button>
